...
[literal,subs="+quotes,verbatim,macros"]
....
$ [command]`pv pass:attributes[{blank}]_/path/to/image.iso_ | sudo dd of=/dev/rdiskpass:attributes[{blank}]_number_ bs=1m`
....
+
[NOTE]
====
...
....
$ pv /Users/user_name/Downloads/{PRODUCT}-server-x86_64-boot.iso | sudo dd of=/dev/rdisk2
....
...
[literal,subs="+quotes,verbatim"]
....
4.39GiB 0:03:08 [23.8MiB/s] [============================================================================================================================================================>] 100%
0+71904 records in
0+71904 records out
4712300544 bytes transferred in 188.501782 secs (24998706 bytes/sec)
....
