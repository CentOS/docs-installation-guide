...
====
+
The default partition size for `/boot` should suffice for most common uses. However, it is recommended that you increase the size of this partition if you are planning on retaining multiple kernel releases or errata kernels.
